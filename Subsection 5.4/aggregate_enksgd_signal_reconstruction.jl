...
axes_reconstructed_input_signal.set_title("EnKSGD Reconstructed \n Input Signals", fontsize=26)
for run in 1:total_runs
...
axes_reconstructed_input_signal.text(-0.3, 1.1, "(C)", size=20, weight="bold", transform=axes_reconstructed_input_signal.transAxes)
