...
@printf("====Table Values====\n")
@printf("EnKF Mean Log10 Objective Value: %1.1E\n", mean(log.(10,final_obj_vals)))
@printf("EnKF Median Log10 Objective Value: %1.1E\n", median(log.(10,final_obj_vals)))
@printf("EnKF Minimum Log10 Objective Value: %1.1E\n", minimum(log.(10,final_obj_vals)))
@printf("EnKF Maximum Log10 Objective Value: %1.1E\n", maximum(log.(10,final_obj_vals)))
@printf("EnKF Variance Log10 Objective Value: %1.1E\n", var(log.(10,final_obj_vals)))
@printf("EnKF Mean Number of Iterations: %d\n", mean(iter_counts))
